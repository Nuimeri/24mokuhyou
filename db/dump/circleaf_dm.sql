...
CREATE TABLE `dm` (
  ...
  KEY `from_account_id_idx` (`create_by`),
  CONSTRAINT `from_account_id` FOREIGN KEY (`create_by`) REFERENCES `account` (`id`),
  CONSTRAINT `to_account_id` FOREIGN KEY (`to_account_id`) REFERENCES `account` (`id`)
